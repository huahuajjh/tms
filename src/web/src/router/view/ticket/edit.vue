<template>
    <modal title="修改订单信息" :visible.sync="visible" :static="true">
        <form class="form-horizontal" v-validation @success="formSuccess">
            <div class="modal-body">
                <div class="form-group" :class="{ 'has-error': !validation.model.Name.isChangePass }">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="请输入游客名称" tabindex="1" v-model="ticket.Name">
                    </div>
                ...
                <div class="form-group" :class="{ 'has-error': !validation.model.Phone.isChangePass }">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="请输入游客手机号码" tabindex="2" v-model="ticket.Phone">
                    </div>
                ...
                <div class="form-group" :class="{ 'has-error': !validation.model.IdCard.isChangePass }">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="请输入游客身份证" tabindex="3" v-model="ticket.IdCard">
                    </div>
                ...
                <div class="form-group" :class="{ 'has-error': !validation.model.Remarks.isChangePass }">
                    ...
                    <div class="col-sm-8">
                        <textarea rows="4" class="form-control" placeholder="请输入备注" tabindex="12" v-model="ticket.Remarks"></textarea>
                    </div>
                ...
                <div class="form-group" :class="{ 'has-error': !validation.model.Recommender.isChangePass }">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" placeholder="请输入推介人" tabindex="13" v-model="ticket.Recommender">
                    </div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-block btn-purple" :disabled="!validation.isPass" tabindex="14">应用</button>
            </div>
        </form>
    </modal>
</template>
<script>
    import datetime from "../../../js/filter/datetime.js";
    import { editTicket } from "../../../js/service/ticketService.js";
    ...
    export default {
        ...
        methods: {
            formSuccess() {
                var self = this;
                ajaxAlert("确定修改该订单信息?", "提示", ()=>{
                    editTicket(self.ticket, (msg)=> {
                        self.visible = false;
                        successAlert(msg);
                        self.reload();
                    }, (msg)=>{
